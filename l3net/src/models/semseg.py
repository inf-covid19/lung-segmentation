...
import time
from l3net.src import utils as ut
from sklearn.metrics import confusion_matrix
import skimage
from haven import haven_utils as hu
from haven import haven_img as hi
from torchvision import transforms
from l3net.src import models
from l3net.src.models import base_networks
...
class SemSeg(torch.nn.Module):
    ...
    def predict(self, input):
        return self.model_base.forward(input)
        # return self.model_base.predict(input)
    ...
    def vis_on_batch(self, batch, savedir_image, save_preds=False):
        ...
        if save_preds:
            ...
            for u in range(self.n_classes):
                ...
                meta_dict['pred_group%d_n_pixels' %
                          u] = float((pred_mask == u).float().sum())
