...
data_description = 'Dados FAPERGS (Nome, ID, PCR, Classificação, TC).xlsx' #file with the data annotations
...
validation_covid_folders = ['C'+str(p) for p in covid_p[:7]]
...
train_model(model, train_df, validation_df, 50)
